...
// Recharts is ~250 KB — lazy-load so it never blocks the initial page render.
const DashboardCharts = dynamic(() => import('./_components/DashboardCharts'), { ssr: false });
...
export default function DashboardPage() {
  ...
  const statCards = [
    ...
    {
      label: 'Outstanding Dues', value: feeSummary ? formatINR(feeSummary.totalDue ?? 0) : '—',
  ...
  return (
    <div className="p-4 sm:p-6 max-w-6xl mx-auto">
      ...
      <DashboardCharts
        trend={trend}
        classStat={classStat}
        onFeesClick={() => router.push('/dashboard/fees')}
        onAttendanceClick={() => router.push('/dashboard/attendance')}
      />
