...
const Icons: Record<string, () => ReactElement> = {
  ...
  salary:     () => <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="5" width="20" height="14" rx="2"/><line x1="2" y1="10" x2="22" y2="10"/></svg>,
  ...
  cert:       () => <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="8" r="6"/><path d="M15.477 12.89L17 22l-5-3-5 3 1.523-9.11"/></svg>,
};
...
const menuGroups = [
  {
    ...
    items: [
      ...
      { label: 'Certificates',          path: '/dashboard/certificates',      icon: 'cert'       },
    ],
  },
  {
    label: 'Academics',
