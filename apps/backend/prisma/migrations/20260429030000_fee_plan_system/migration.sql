...
-- Existing fee_heads / fee_structures / fee_payments tables are untouched.
...
CREATE UNIQUE INDEX "fee_plans_institutionId_name_academicYearId_key"
    ON "fee_plans"("institutionId", "name", "academicYearId");
CREATE INDEX "fee_plans_institutionId_idx" ON "fee_plans"("institutionId");
CREATE INDEX "fee_plans_academicYearId_idx" ON "fee_plans"("academicYearId");
...
CREATE UNIQUE INDEX "fee_plan_items_feePlanId_feeCategoryId_key"
...
CREATE UNIQUE INDEX "fee_plan_installments_feePlanItemId_label_key"
...
CREATE TABLE "fee_plan_class_maps" (
    "id"             TEXT NOT NULL,
    "feePlanId"      TEXT NOT NULL,
    "academicUnitId" TEXT NOT NULL,
    CONSTRAINT "fee_plan_class_maps_pkey" PRIMARY KEY ("id")
);
CREATE UNIQUE INDEX "fee_plan_class_maps_feePlanId_academicUnitId_key"
...
CREATE INDEX "fee_concessions_institutionId_idx" ON "fee_concessions"("institutionId");
...
CREATE UNIQUE INDEX "fee_collections_institutionId_receiptNo_key"
    ON "fee_collections"("institutionId", "receiptNo");
CREATE INDEX "fee_collections_institutionId_idx" ON "fee_collections"("institutionId");
CREATE INDEX "fee_collections_studentId_idx" ON "fee_collections"("studentId");
CREATE INDEX "fee_collections_paidOn_idx" ON "fee_collections"("paidOn");
CREATE INDEX "fee_collections_academicYearId_idx" ON "fee_collections"("academicYearId");
CREATE INDEX "fee_collections_feePlanInstallmentId_idx" ON "fee_collections"("feePlanInstallmentId");
